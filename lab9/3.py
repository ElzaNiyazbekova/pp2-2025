...
background = pygame.image.load(r'/Users/elzaniyazbekova/Desktop/pp2/lab9/AnimatedStreet.png') #загружаем фон
...
class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load(r'/Users/elzaniyazbekova/Desktop/pp2/lab9/Enemy.png')
...
class Monet(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load(r'/Users/elzaniyazbekova/Desktop/pp2/lab9/Monet.png')
        self.rect = self.image.get_rect()
        self.rect.center = (random.randint(40,SCREEN_WIDTH-40), 0)
    def move(self):
        global POINT
    ...
    def reset(self):
        ...
        if (POINT+1) % 5 ==0 and POINT!=0:
            ...
            self.image = pygame.image.load(r'/Users/elzaniyazbekova/Desktop/pp2/lab9/Monet2.png')
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__() 
        self.image = pygame.image.load(r'/Users/elzaniyazbekova/Desktop/pp2/lab9/Player.png')
        self.rect = self.image.get_rect()
...
while True:
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
          pygame.mixer.Sound(r'/Users/elzaniyazbekova/Desktop/pp2/lab9/lab8_materials_crash.wav').play()
          time.sleep(1)
